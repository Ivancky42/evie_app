...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  void initState() {
    ...
    widget.controller.selectYearOnly ?
    YearSelector(
      key: widget.controller.yearSelectorState,
      onYearSelected: _onOnlyYearSelected,
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: widget.controller.theme.copyWith(dialogTheme: DialogThemeData(backgroundColor: Colors.transparent)),
      child: Dialog(
        child: Builder(
          builder: (BuildContext context) {
            if (portrait) {
  ...
  void _onOnlyYearSelected(final int year) {
    setState(
          () {
