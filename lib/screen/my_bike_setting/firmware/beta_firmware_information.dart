...
class _BetaFirmwareInformationState extends State<BetaFirmwareInformation> {
              ...
              child: Column(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Container(),
                      if(_firmwareProvider.isBetaVersion == false)...{
                        Padding(
                          padding: EdgeInsets.fromLTRB(16.w, 24.h, 16.w,13.h),
                          child: Text(
                            "Test out our latest features in this beta software.",
                            style: EvieTextStyles.h2,
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Your software is already at its best!",
                            style:EvieTextStyles.h2,
                          ),
                        ),
                        Padding(
                          ...
                          child: Text(
                            "No updates are currently available for your software. Rest assured, you're already using the most recent version, fully equipped with all the functionalities you need.",
                            style: EvieTextStyles.body18,
                          )
                        ),
                      },
                      SizedBox(
                        height:  _firmwareProvider.isUpdating ? 80.h : 200.h,
                      )
                    ],
                  ),
                  Column(
                    children: [
                      Visibility(
                        visible: _firmwareProvider.isBetaVersion == false || _firmwareProvider.isUpdating,
                          child: Padding(
