...
class BikeScanning extends StatefulWidget {
  const BikeScanning({Key? key}) : super(key: key);

  @override
  _BikeScanningState createState() => _BikeScanningState();
}

class _BikeScanningState extends State<BikeScanning> {
