...
class AdminFreePlan extends StatefulWidget {
  const AdminFreePlan({Key? key}) : super(key: key);

  @override
  _AdminFreePlanState createState() => _AdminFreePlanState();
}
                                  ...
                                  SmartDialog.show(widget: EvieDoubleButtonDialog(
                                      ...
                                      onPressedRight: () {
                                        ...
                                        checkBLEPermissionAndAction(
                                            _bluetoothProvider, deviceConnectResult ?? DeviceConnectResult.disconnected, connectStream);
                                        pageNavigate = 0;
                                      }));
                                }
                            }
