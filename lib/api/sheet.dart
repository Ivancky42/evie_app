...
//   // );
//
//   showCupertinoSheet(context, EvieBottomSheet(childContext: SheetNavigator(source ?? 'Home', strings ?? '')));
// }
//
...
//   // );
//
//   showCupertinoSheet(context, EvieBottomSheet(childContext: BikeSetting(source ?? 'Home')));
// }
//
...
//               builder: (context) => EvieBottomSheet(childContext: BatteryDetails(),),
//             );
//           }
//
